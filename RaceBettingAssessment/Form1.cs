...
using RaceBettingAssessment.Business.AllPunters;

namespace RaceBettingAssessment
{
    public partial class Form1 : Form
    {
        ...
        private void RunRace()
        {
            ...
            while (end != true)
            {
                int Distance = Form1.ActiveForm.Width - pb1.Width;
        ...
        private void rbZoe_CheckedChanged(object sender, EventArgs e)
        {
